...
const ToggleSwitch = ({ isEnabled, onToggle, label }) => (
    <div className="flex items-center justify-between">
        ...
        <button
            onClick={onToggle}
            className={`relative inline-flex items-center h-6 rounded-full w-11 transition-colors duration-300 focus:outline-none ${isEnabled ? 'bg-blue-600' : 'bg-gray-700/50'
                }`}
        >
            <span
